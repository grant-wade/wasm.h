...
static void wasi_test_build_core_instance_source_module_named(wasi_test_builder_t* mod, const char* export_name) {
    wasi_test_builder_t sec = { 0 };
    static const uint8_t i32_param[] = { 0x7F };
    static const uint8_t i32_result[] = { 0x7F };
    static const uint8_t empty[] = { 0 };
    ...
    memset(&sec, 0, sizeof(sec));
    wasi_test_emit_leb128_u32(&sec, 1u);
    wasi_test_emit_export(&sec, export_name ? export_name : "", 0x00u, 0u);
    wasi_test_emit_section(mod, 7u, sec.buf, sec.len);
...
static void wasi_test_build_core_instance_source_module(wasi_test_builder_t* mod) {
    wasi_test_build_core_instance_source_module_named(mod, "inc");
}
...
static void wasi_test_build_core_instance_importing_module_named_field(wasi_test_builder_t* mod,
    ...
    memset(&sec, 0, sizeof(sec));
    wasi_test_emit_leb128_u32(&sec, 1u);
    wasi_test_emit_leb128_u32(&sec, (uint32_t)module_name_len);
    wasi_test_emit_bytes(&sec, (const uint8_t*)module_name, (uint32_t)module_name_len);
    wasi_test_emit_leb128_u32(&sec, (uint32_t)field_name_len);
    wasi_test_emit_bytes(&sec, (const uint8_t*)field_name, (uint32_t)field_name_len);
    wasi_test_emit(&sec, 0x00u);
    wasi_test_emit_leb128_u32(&sec, 0u);
    wasi_test_emit_section(mod, 2u, sec.buf, sec.len);
...
static void wasi_test_build_unnamed_core_namespace_func_component_named_source_export(wasi_test_builder_t* component,
                                                                                      const wasi_test_builder_t* source_module,
                                                                                      const char* source_export_name,
                                                                                      const wasi_test_builder_t* importing_module) {
    wasi_test_builder_t sec = { 0 };
    ...
    memset(&sec, 0, sizeof(sec));
    wasi_test_emit_leb128_u32(&sec, 1u);
    wasi_test_emit_core_instance_export_alias(&sec, 0x00u, 0u, source_export_name ? source_export_name : "");
    wasi_test_emit_section(component, 6u, sec.buf, sec.len);
    ...
    wasi_test_emit(&sec, 0x01u);
    wasi_test_emit_leb128_u32(&sec, 1u);
    wasi_test_emit_component_plain_name(&sec, "");
    wasi_test_emit(&sec, 0x00u);
    wasi_test_emit_leb128_u32(&sec, 0u);
...
static void wasi_test_build_unnamed_core_namespace_func_component(wasi_test_builder_t* component,
                                                                  const wasi_test_builder_t* source_module,
                                                                  const wasi_test_builder_t* importing_module) {
    wasi_test_build_unnamed_core_namespace_func_component_named_source_export(component,
                                                                              source_module,
                                                                              "inc",
                                                                              importing_module);
}

static void wasi_test_build_direct_core_export_func_arg_component(wasi_test_builder_t* component,
                                                                  const wasi_test_builder_t* source_module,
                                                                  const char* source_export_name,
                                                                  const wasi_test_builder_t* importing_module) {
    wasi_test_builder_t sec = { 0 };
...
static void wasi_test_build_core_from_exports_alias_lift_component(wasi_test_builder_t* component,
                                                                   const wasi_test_builder_t* source_module) {
    wasi_test_builder_t sec = { 0 };
    ...
    wasi_test_emit_leb128_u32(&sec, 2u);
    wasi_test_emit_core_instance_export_alias(&sec, 0x00u, 0u, "inc");
    wasi_test_emit_core_instance_export_alias(&sec, 0x00u, 1u, "inc");
    wasi_test_emit_section(component, 6u, sec.buf, sec.len);
...
static void wasi_test_build_direct_lower_core_func_arg_component(wasi_test_builder_t* component,
                                                                 const wasi_test_builder_t* caller_module) {
    wasi_test_builder_t sec = { 0 };
...
static void wasi_test_build_reexported_canon_lower_namespace_component(wasi_test_builder_t* component,
                                                                       const wasi_test_builder_t* caller_module) {
    wasi_test_builder_t sec = { 0 };
    ...
    memset(&sec, 0, sizeof(sec));
    wasi_test_emit_leb128_u32(&sec, 1u);
    wasi_test_emit_core_instance_export_alias(&sec, 0x00u, 0u, "dep");
    wasi_test_emit_section(component, 6u, sec.buf, sec.len);
    ...
    wasi_test_emit(&sec, 0x01u);
    wasi_test_emit_leb128_u32(&sec, 1u);
    wasi_test_emit_component_plain_name(&sec, "dep2");
    wasi_test_emit(&sec, 0x00u);
    wasi_test_emit_leb128_u32(&sec, 1u);
...
static void wasi_test_build_outer_resource_destructor_child_component(wasi_test_builder_t* component) {
    wasi_test_builder_t sec = { 0 };
...
static void wasi_test_build_parent_outer_resource_destructor_component(wasi_test_builder_t* component,
                                                                       const wasi_test_builder_t* nested_component,
                                                                       const wasi_test_builder_t* core_module) {
    wasi_test_builder_t sec = { 0 };
...
static void wasi_test_build_nested_component_lower_alias_lift_component(wasi_test_builder_t* component,
                                                                        const wasi_test_builder_t* nested_component) {
    wasi_test_builder_t sec = { 0 };
...
WL_TEST(test_wasi_resource_destructor_resolves_outer_func_alias) {
    wasi_engine_t engine;
    wasi_test_builder_t module_bytes;
    ...
    wasi_test_resource_drop_state_t drop_state;
    uint32_t handle = UINT32_MAX;
    uint32_t representation_value = 144u;
    wasi_error_t err;
    ...
    wasi_test_build_resource_destructor_core_module(&module_bytes);
    wasi_test_build_outer_resource_destructor_child_component(&child_component_bytes);
    wasi_test_build_parent_outer_resource_destructor_component(&parent_component_bytes,
    ...
    core_module = parent_instance->core_module;
    WL_REQUIRE(t, core_module != NULL);
    ...
    WL_CHECK(t, child_instance->parent_instance == parent_instance);
    ...
    WL_REQUIRE_MSG(t, resource_type != WASI_RESOURCE_TYPE_INVALID, "wasi_define_resource failed: %s", engine.error_msg);
    WL_REQUIRE_MSG(t,
                   wasi_instance_bind_resource_type(child_instance, 0u, resource_type) == WASI_OK,
                   "wasi_instance_bind_resource_type failed: %s",
                   engine.error_msg);
    WL_REQUIRE_MSG(t,
                   wasi_resource_new(child_instance, 0u, (void*)(uintptr_t)representation_value, &handle) == WASI_OK,
                   "wasi_resource_new failed: %s",
                   engine.error_msg);

    err = wasi_resource_drop(child_instance, 0u, handle);
    WL_REQUIRE_MSG(t, err == WASI_OK, "wasi_resource_drop failed: %s", engine.error_msg);
    wasi_test_expect_i32_global(t, core_module, "last_drop", (int32_t)representation_value);
    wasi_test_expect_i32_global(t, core_module, "drop_count", 1);
    WL_CHECK(t, drop_state.drops == 1u);
...
WL_TEST(test_wasi_call_resolves_core_from_exports_alias_lifts) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t component_bytes;
    wasi_component_t* component;
    ...
    wasi_test_build_core_instance_source_module(&source_module_bytes);
    wasi_test_build_core_from_exports_alias_lift_component(&component_bytes, &source_module_bytes);
    ...
    WL_CHECK(t, wasi_component_alias_instance_index(component, 1u) == 1u);
    WL_CHECK(t, strcmp(wasi_component_alias_name(component, 1u), "inc") == 0);
...
WL_TEST(test_wasi_call_resolves_core_from_exports_canon_lower_lifts) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t child_component_bytes;
    wasi_test_builder_t parent_component_bytes;
    ...
    wasi_test_build_core_instance_source_module(&source_module_bytes);
    wasi_test_build_core_instance_u32_component(&child_component_bytes, &source_module_bytes);
    wasi_test_build_nested_component_lower_alias_lift_component(&parent_component_bytes, &child_component_bytes);

    component = wasi_load(&engine, parent_component_bytes.buf, parent_component_bytes.len);
    WL_REQUIRE_MSG(t, component != NULL, "wasi_load failed: %s", engine.error_msg);
    WL_CHECK(t, wasi_component_nested_component_count(component) == 1u);
    WL_CHECK(t, wasi_component_core_instance_count(component) == 1u);
    WL_CHECK(t, wasi_component_core_instance_kind(component, 0u) == WASI_COMPONENT_CORE_INSTANCE_KIND_FROM_EXPORTS);
    WL_CHECK(t, wasi_component_alias_count(component) == 2u);
    WL_CHECK(t, wasi_component_canon_count(component) == 2u);
    WL_CHECK(t, wasi_component_canon_kind(component, 0u) == WASI_COMPONENT_CANON_KIND_LOWER);
    WL_CHECK(t, wasi_component_canon_kind(component, 1u) == WASI_COMPONENT_CANON_KIND_LIFT);
...
WL_TEST(test_wasi_instantiate_links_direct_func_args_to_unnamed_canon_lower) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t source_component_bytes;
    wasi_test_builder_t caller_module_bytes;
    ...
    wasi_test_build_core_instance_u32_component(&source_component_bytes, &source_module_bytes);
    wasi_test_build_core_instance_importing_module(&caller_module_bytes);
    wasi_test_build_direct_lower_core_func_arg_component(&component_bytes, &caller_module_bytes);
    ...
    instance = wasi_instantiate(component);
    WL_REQUIRE_MSG(t, instance != NULL, "wasi_instantiate failed: %s", engine.error_msg);
    WL_REQUIRE(t, instance->num_core_instances == 1u);
    core_module = instance->core_instances[0].module;
    WL_REQUIRE(t, core_module != NULL);

    arg = wasm_i32(99);
    memset(&result, 0, sizeof(result));
    wasm_err = wasm_call(core_module, "call_dep", &arg, 1u, &result, 1u);
    WL_REQUIRE_MSG(t, wasm_err == WASM_OK, "wasm_call call_dep failed: %s", wasm_runtime_error_message(engine.runtime));
    WL_CHECK(t, result.type == WASM_TYPE_I32);
    WL_CHECK(t, result.of.i32 == 100);
...
WL_TEST(test_wasi_instantiate_links_direct_func_args_to_empty_import_field) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t source_component_bytes;
    wasi_test_builder_t caller_module_bytes;
...
WL_TEST(test_wasi_instantiate_links_direct_func_args_from_empty_source_export_name) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t caller_module_bytes;
    wasi_test_builder_t component_bytes;
    ...
    wasi_test_build_core_instance_source_module_named(&source_module_bytes, "");
    wasi_test_build_core_instance_importing_module(&caller_module_bytes);
    wasi_test_build_direct_core_export_func_arg_component(&component_bytes,
                                                          &source_module_bytes,
                                                          "",
                                                          &caller_module_bytes);
    ...
    WL_CHECK(t, wasi_component_alias_count(component) == 1u);
    WL_CHECK(t, wasi_component_core_instance_count(component) == 2u);
    WL_CHECK(t, wasi_component_core_instance_arg_kind(component, 1u, 0u) == 0x00u);

    instance = wasi_instantiate(component);
    WL_REQUIRE_MSG(t, instance != NULL, "wasi_instantiate failed: %s", engine.error_msg);
    WL_REQUIRE(t, instance->num_core_instances == 2u);
    core_module = instance->core_instances[1].module;
    WL_REQUIRE(t, core_module != NULL);
...
WL_TEST(test_wasi_instantiate_links_named_canon_lower_reexports_through_alias_chain) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t source_component_bytes;
    wasi_test_builder_t caller_module_bytes;
    ...
    wasi_test_build_core_instance_source_module(&source_module_bytes);
    wasi_test_build_core_instance_u32_component(&source_component_bytes, &source_module_bytes);
    wasi_test_build_core_instance_importing_module_named_field(&caller_module_bytes, "dep", "dep2");
    wasi_test_build_reexported_canon_lower_namespace_component(&component_bytes, &caller_module_bytes);
    ...
    instance = wasi_instantiate(component);
    WL_REQUIRE_MSG(t, instance != NULL, "wasi_instantiate failed: %s", engine.error_msg);
    WL_REQUIRE(t, instance->num_core_instances == 3u);
    core_module = instance->core_instances[2].module;
    WL_REQUIRE(t, core_module != NULL);
...
WL_TEST(test_wasi_instantiate_links_from_exports_namespace_with_empty_import_field) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t caller_module_bytes;
    wasi_test_builder_t component_bytes;
    ...
    wasi_test_build_core_instance_source_module(&source_module_bytes);
    wasi_test_build_core_instance_importing_module_named_field(&caller_module_bytes, "dep", "");
    wasi_test_build_unnamed_core_namespace_func_component(&component_bytes,
                                                          &source_module_bytes,
                                                          &caller_module_bytes);
...
WL_TEST(test_wasi_instantiate_links_from_exports_namespace_with_unnamed_func_export) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t caller_module_bytes;
    wasi_test_builder_t component_bytes;
    ...
    WL_CHECK(t, wasi_component_core_instance_count(component) == 3u);
    WL_CHECK(t, wasi_component_core_instance_kind(component, 1u) == WASI_COMPONENT_CORE_INSTANCE_KIND_FROM_EXPORTS);
    WL_CHECK(t, strcmp(wasi_component_core_instance_export_name(component, 1u, 0u), "") == 0);
...
WL_TEST(test_wasi_instantiate_links_from_exports_namespace_with_empty_source_export_name) {
    wasi_engine_t engine;
    wasi_test_builder_t source_module_bytes;
    wasi_test_builder_t caller_module_bytes;
    wasi_test_builder_t component_bytes;
    ...
    wasi_test_build_core_instance_source_module_named(&source_module_bytes, "");
    wasi_test_build_core_instance_importing_module(&caller_module_bytes);
    wasi_test_build_unnamed_core_namespace_func_component_named_source_export(&component_bytes,
                                                                              &source_module_bytes,
                                                                              "",
                                                                              &caller_module_bytes);
...
int main(void) {
    static const wl_test_case cases[] = {
        ...
        WL_TEST_CASE(test_wasi_resource_destructor_resolves_outer_func_alias),
        ...
        WL_TEST_CASE(test_wasi_call_resolves_core_from_exports_alias_lifts),
        ...
        WL_TEST_CASE(test_wasi_instantiate_links_direct_func_args_from_empty_source_export_name),
        ...
        WL_TEST_CASE(test_wasi_instantiate_links_from_exports_namespace_with_empty_source_export_name),
